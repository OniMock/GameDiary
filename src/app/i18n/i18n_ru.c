...
const char* g_lang_ru_entries[MSG_COUNT] = {
    ...
    [MSG_HELP_DESC_PLUGIN_SETTINGS] = "Включает или отключает горячую клавишу плагина. Удерживайте L+R+SELECT в игре 2 секунды, чтобы переключить её. Когда отключено, отслеживание времени игры игнорирует список блокировки, а комбинация клавиш становится неактивной. Сохраняется в plugin.dat на карте памяти.",
