...
const char* g_lang_cn_entries[MSG_COUNT] = {
    ...
    [MSG_SETTINGS_PLUGIN_ICONS]     = "保存游戏图标",
    [MSG_SETTINGS_PLUGIN_CAPTURE]           = "记录内容",
    [MSG_SETTINGS_PLUGIN_CAPTURE_GAMES]     = "游戏",
    ...
    [MSG_SETTINGS_PLUGIN_CAPTURE_UNKNOWN]   = "未知",
    [MSG_HELP_DESC_PLUGIN_SETTINGS] = "插件选项保存到 plugin.dat。快捷键：在游戏中长按 L+R+SELECT 可切换记录功能（关闭 = 始终记录）。\n图标：注册新游戏时保存 PNG 封面。\n记录内容：选择插件记录的类型。更改将在下次启动游戏时生效。",
