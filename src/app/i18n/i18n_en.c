...
const char* g_lang_en_entries[MSG_COUNT] = {
    ...
    [MSG_HELP_DESC_INFO]           = "Detailed information about the application, version, credits, and project support.",
    ...
    [MSG_SUPPORT_DESC]             = "If you like my work and want to help keep it active, consider making a donation. It's not mandatory, but it helps a lot in the evolution of the project!",
    [MSG_SUPPORT_COFFEE]           = "Buy Me A Coffee",
    [MSG_SUPPORT_WALLET]           = "Wallet EVM",

    [MSG_INFO_CHECK_VERSION]       = "Check version",
    [MSG_INFO_VERSION_LATEST]      = "You are using the latest version",
    [MSG_INFO_VERSION_AVAILABLE]   = "New version available",
    ...
    [MSG_SETTINGS_PLUGIN_ICONS]     = "Save Game Icons",
    [MSG_SETTINGS_PLUGIN_CAPTURE]           = "Track Content",
    [MSG_SETTINGS_PLUGIN_CAPTURE_GAMES]     = "Games",
    ...
    [MSG_SETTINGS_PLUGIN_CAPTURE_UNKNOWN]   = "Unknown",
    [MSG_HELP_DESC_PLUGIN_SETTINGS] = "Plugin options saved to plugin.dat. Hotkey: hold L+R+SELECT in-game to toggle tracking (off = always track).\nIcons: save PNG covers when a new game is registered.\nTrack Content: choose which types the plugin records. Changes apply the next time a title is launched.",
    ...
    [MSG_MENU_LEADERBOARD]         = "Leaderboard",
    [MSG_HELP_BTN_TRIANGLE_TOP]    = "[ △ ]: Top of list",
