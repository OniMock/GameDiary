...
const char* g_lang_jp_entries[MSG_COUNT] = {
    ...
    [MSG_SETTINGS_PLUGIN_CAPTURE]           = "記録するコンテンツ",
    [MSG_SETTINGS_PLUGIN_CAPTURE_GAMES]     = "ゲーム",
