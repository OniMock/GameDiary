...
typedef enum {
    ...
    MSG_HELP_DESC_BACKUP,
    MSG_HELP_CLOSE_HINT,

    MSG_INFO_CHECK_VERSION,
    MSG_INFO_VERSION_LATEST,
    MSG_INFO_VERSION_AVAILABLE,
    MSG_INFO_VERSION_ERROR, // Generic error fallback
    MSG_INFO_VERSION_CONN_ERROR,
    MSG_INFO_VERSION_PARSE_ERROR,
    ...
    MSG_BACKUP_EXPORT,
    MSG_BACKUP_IMPORT,
    MSG_BACKUP_EXPORT_OK,
    MSG_BACKUP_IMPORT_WARN,
    MSG_BACKUP_IMPORT_OK,
    MSG_BACKUP_ERROR,
    MSG_BACKUP_NOT_FOUND,

    MSG_SETTINGS_PLUGIN,
    MSG_SETTINGS_PLUGIN_HOTKEY,
    MSG_SETTINGS_PLUGIN_ICONS,
    MSG_SETTINGS_PLUGIN_CAPTURE,
    MSG_SETTINGS_PLUGIN_CAPTURE_GAMES,
    MSG_SETTINGS_PLUGIN_CAPTURE_PS1,
    MSG_SETTINGS_PLUGIN_CAPTURE_HOMEBREW,
    MSG_SETTINGS_PLUGIN_CAPTURE_PSP_APP,
    MSG_SETTINGS_PLUGIN_CAPTURE_UNKNOWN,
    MSG_HELP_DESC_PLUGIN_SETTINGS,
    MSG_SETTINGS_FORMATTING,
    MSG_FORMATTING_HOURS_ONLY,
    MSG_HELP_DESC_FORMATTING,

    MSG_MENU_LEADERBOARD,
    MSG_HELP_BTN_TRIANGLE_TOP,
    MSG_HELP_BTN_X_BOTTOM,
    MSG_HELP_DESC_LEADERBOARD,

    MSG_GAME_DELETE_WARN,
    MSG_GAME_DELETE_OK,
    MSG_HELP_BTN_TRIANGLE_DELETE,
